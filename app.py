...
<input type="number" name="pawn_amount" placeholder="Оценочная стоимость" step="0.01" value="{{ contract.pawn_amount if contract else '' }}">
<input type="number" name="loan_amount" placeholder="Сумма займа" step="0.01" value="{{ contract.loan_amount if contract else '' }}" required>
